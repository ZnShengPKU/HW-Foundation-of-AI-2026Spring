...
def loss_fn(y_true, y_pred):
    return np.sum(np.square(y_true - y_pred), axis=-1, keepdims=False)
...
def trainer(net, X_train, y_train, X_val, y_val, epochs=10, batch_size=64, exp_name="default"):
...
if __name__ == '__main__':
    ...
    trainer(net_exp1, X_train, y_train, X_val, y_val, epochs=EPOCHS, batch_size=BATCH_SIZE, exp_name="Exp1_Baseline_MSE")
    ...
    trainer(net_exp2, X_train, y_train, X_val, y_val, epochs=EPOCHS, batch_size=BATCH_SIZE, exp_name="Exp2_CE_Loss")
    ...
    trainer(net_exp3, X_train, y_train, X_val, y_val, epochs=EPOCHS, batch_size=BATCH_SIZE, exp_name="Exp3_Deeper_256_256")
    ...
    trainer(net_exp4, X_train, y_train, X_val, y_val, epochs=EPOCHS, batch_size=BATCH_SIZE, exp_name="Exp4_Wider_1024")
    ...
    trainer(net_exp5, X_train, y_train, X_val, y_val, epochs=EPOCHS, batch_size=BATCH_SIZE, exp_name="Exp5_SwiGLU")
